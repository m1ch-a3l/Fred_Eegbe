...
const testimonials = [
  {
    quote: "The teachings of Rev. Dr. Fred P. Deegbe transformed my understanding of purpose. For the first time, I understood that my calling was not about performance — it was about relationship with God.",
    name: "Amara O.",
