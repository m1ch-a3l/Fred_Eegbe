...
export const metadata: Metadata = {
  title: "Teachings — Rev. Dr. Fred P. Deegbe",
  description: "Sermons, devotionals, and teachings by Rev. Dr. Fred P. Deegbe — scripture-based messages to strengthen your faith.",
};
